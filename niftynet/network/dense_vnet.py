...
class DenseVNet(BaseNet):
    ...
    def layer_op(self, input_tensor, is_training, layer_id=-1):
        ...
        #Segmentation = tf.convert_to_tensor(segmentation, name="MYTENSOR")
        #print("-.--------------My tensor namee MYTENSOR,", Segmentation.name)
        

        #WIT = tf.convert_to_tensor(WI, name="MYWIT")
        #print("WWWWWWWWWWWWWWWWWWWWWWWWWWit: ", WIT.name)
